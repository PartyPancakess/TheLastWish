...
public class ResumeState extends State{
	...
	public ResumeState(Game gameIn) {
		super(gameIn);
		game = gameIn;
	}
	...
	public void render(Graphics graphics) {
		if(!start) {
			...
			Resources.drawString(graphics, "Resume", startX + width / 2 , startY + height / 2, true, Color.WHITE, Resources.font56);
		}
		else if(start) {
			if(game.isLeftButtonPressed()) {
				//graphics.drawImage(Resources.start2, startX, startY, width, height, null);
				Resources.drawString(graphics, "Resume", startX + width / 2 , startY + height / 2, true, Color.red, Resources.font56);
			}
			else {
				//graphics.drawImage(Resources.start1, startX, startY, width, height, null);
				Resources.drawString(graphics, "Resume", startX + width / 2 , startY + height / 2, true, Color.CYAN, Resources.font56);
			}
		}
